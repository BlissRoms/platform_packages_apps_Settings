...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSafeHeadsetVolume.setChecked(CMSettings.System.getInt(getContentResolver(),
        ...
        if (KEY_SAFE_HEADSET_VOLUME.equals(key)) {
            if ((Boolean) objValue) {
                CMSettings.System.putInt(getContentResolver(),
                        CMSettings.System.SAFE_HEADSET_VOLUME, 1);
            } else {
            ...
            switch (id) {
                ...
                case DLG_SAFE_HEADSET_VOLUME:
                    ...
                    .setPositiveButton(R.string.dlg_ok,
                        new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            CMSettings.System.putInt(getOwner().getContentResolver(),
