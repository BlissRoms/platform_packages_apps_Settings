...
public class BlissUpdatePreferenceController extends BasePreferenceController {
    ...
    public BlissUpdatePreferenceController(Context context) {
    ...
    public int getAvailabilityStatus() {
        String buildtype = SystemProperties.get(BLISS_BUILD_TYPE_PROP,"unofficial");
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("official")){
            return UNSUPPORTED_ON_DEVICE;
        }
        try {
            PackageManager pm = mContext.getPackageManager();
            pm.getPackageInfo(BLISS_UPDATER_PACKAGE, PackageManager.GET_ACTIVITIES);
        } catch (Exception e) {
            return UNSUPPORTED_ON_DEVICE;
        }
        return AVAILABLE;
